...
[image2]: ./examples/normalize.jpg "normalizing"
...
Pre-processing technique - Normalized image data using image/255.0 - 0.5
...
3. Used the LeNet architecture for this project, with changes to handle color images. This architecture with no change in layers seemed to work fine.
4. Used dropout as the model was overfitting, tried different probablities based on the overfitting but k_prob = 0.5 worked the best.
